	...
	function navi() {
		...
		$("#gnb").on("mouseenter", "> .box > ul > li", function() {
			if($("body").data("device") != "mobile") {
				...
				$(this).parents(".h_group").css("background","url(/resources/img/menu_bg.png)");
			...
			if($("body").data("device") != "mobile") {
				...
				$("#gnb > .box > ul > li").parents(".h_group").stop().animate({"height":"91px"}, 300, function() {
					...
					if($(".h_group").hasClass('affix')) {
						$(this).css("background","url(/resources/img/menu_bg.png)");
						$("#gnb > .box > ul > li > a").css("color","#444");
					} else {
	...
	function sticky() {
		...
		$(window).on('scroll', $.throttle(1000 / 15, function() {
			...
			if ( $(document).scrollTop() > fixed_offset.top ) {
				...
				$('.h_group').css("background","#fff url(/resources/img/menu_bg.png)");
				$("#gnb > .box > ul > li > a").css("color","#444");
			} else {

...
<head>
	...
	<script src="/holdings/resources/js/main.js?<%=queryString%>"></script>

	<!-- <script src="/holdings/resources/js/popup.js"></script> -->
	...
	<div id="hold_popup" class="modal_box">
		...
		<div class="modal_body">
			...
			<span class="popup_logo">
				<img src="http://222.236.61.86:81/holdings/resources/img/common/logo.png" alt="SK 주식회사">
			</span>
